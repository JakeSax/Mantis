...
final class CropViewTests: XCTestCase {
    ...
    func testGetRatioType() {
        XCTAssertEqual(
            cropView.getRatioType(byImageIsOriginalHorizontal: true),
            cropViewModel.getRatioType(byImageIsOriginalHorizontal: true)
        )
        XCTAssertEqual(
            cropView.getRatioType(byImageIsOriginalHorizontal: false),
            cropViewModel.getRatioType(byImageIsOriginalHorizontal: false)
        )
        XCTAssertNotEqual(
            cropView.getRatioType(byImageIsOriginalHorizontal: true),
            cropViewModel.getRatioType(byImageIsOriginalHorizontal: false)
    ...
    private func testGetImageHorizontalToVerticalRatioWithUpDownAndMirror(testImage: UIImage) {
        ...
        XCTAssertEqual(
            cropView.getImageHorizontalToVerticalRatio(),
            Double(testImage.size.width / testImage.size.height)
        )
        ...
        XCTAssertEqual(
            cropView.getImageHorizontalToVerticalRatio(),
            Double(testImage.size.height / testImage.size.width)
        )
    ...
    func testGetImageHorizontalToVerticalRatio() {
        ...
        let upMirroredOrientationImage = UIImage(
        ...
        let downMirroredOrientationImage = UIImage(
            cgImage: testImage.cgImage!,
            scale: testImage.scale,
        ...
        let leftMirroredOrientationImage = UIImage(
            cgImage: testImage.cgImage!,
            scale: testImage.scale,
        ...
        let rightMirroredOrientationImage = UIImage(
            cgImage: testImage.cgImage!,
            scale: testImage.scale,
