...
extension CropAuxiliaryIndicatorView {
    ...
    func setupAccessibilityHelperViews() {
        ...
        for index in 0 ..< 8 {
            ...
            switch handleType {
            case .topLeft:
                helperView.accessibilityLabel = LocalizedHelper.getString(
                    "Mantis.Top left crop handle",
                    value: "Top left crop handle"
                )
            case .top:
                helperView.accessibilityLabel = LocalizedHelper.getString(
                    "Mantis.Top crop handle",
                    value: "Top crop handle"
                )
            case .topRight:
                helperView.accessibilityLabel = LocalizedHelper.getString(
                    "Mantis.Top right crop handle",
                    value: "Top right crop handle"
                )
            case .right:
                helperView.accessibilityLabel = LocalizedHelper.getString(
                    "Mantis.Right crop handle",
                    value: "Right crop handle"
                )
            case .bottomRight:
                helperView.accessibilityLabel = LocalizedHelper.getString(
                    "Mantis.Bottom right crop handle",
                    value: "Bottom right crop handle"
                )
            case .bottom:
                helperView.accessibilityLabel = LocalizedHelper.getString(
                    "Mantis.Bottom crop handle",
                    value: "Bottom crop handle"
                )
            case .bottomLeft:
                helperView.accessibilityLabel = LocalizedHelper.getString(
                    "Mantis.Bottom left crop handle",
                    value: "Bottom left crop handle"
                )
            case .left:
                helperView.accessibilityLabel = LocalizedHelper.getString(
                    "Mantis.Left crop handle",
                    value: "Left crop handle"
                )
            case .none:
                break
            }
            
            helperView.accessibilityHint = LocalizedHelper.getString(
                "Mantis.Double tap and hold to adjust crop area",
    ...
    func layoutAccessibilityHelperViews() {
        ...
        for (index, helperView) in accessibilityHelperViews.enumerated() {
            ...
            switch handleType {
            case .topLeft:
                helperView.frame = CGRect(
                    x: -cropBoxHotAreaUnit / 2,
            ...
            case .topRight:
                helperView.frame = CGRect(
                    x: bounds.width - cropBoxHotAreaUnit / 2,
                    y: -cropBoxHotAreaUnit / 2,
                    width: cropBoxHotAreaUnit,
                    height: cropBoxHotAreaUnit
                )
